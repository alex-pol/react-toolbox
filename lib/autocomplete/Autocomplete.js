  ...
  var Autocomplete = function (_Component) {
    ...
    function Autocomplete() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        _this.props.onQueryChange(value);
    ...
    _createClass(Autocomplete, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            other = _objectWithoutProperties(_props, ['allowCreate', 'error', 'label', 'source', 'suggestionMatch', 'selectedPosition', 'keepFocusOnChange', 'showSuggestionsWhenValueIsSet', 'theme', 'onQueryChange']);
